...
import { botonesFlujo, panelVersiones, barraEdicion } from './flujo-cliente';
 ...
 */
export function cabeceraDocumento(o: { etiqueta: string; cliente: string; operador?: OpcionesBarra; puedeEditar?: boolean }): string {
  ...
  <div class="cabecera-acciones">
    ...
    ${o.operador ? botonesFlujo(Boolean(o.puedeEditar)) : ''}
