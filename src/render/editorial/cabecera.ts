 ...
 */
export function cabeceraDocumento(o: { etiqueta: string; cliente: string; operador?: OpcionesBarra; puedeEditar?: boolean; puedeComentar?: boolean }): string {
  ...
  <div class="cabecera-acciones">
    ...
    ${o.operador ? botonesFlujo(Boolean(o.puedeEditar), Boolean(o.puedeComentar)) : ''}
...
${o.operador && o.puedeEditar ? panelVersiones() + barraEdicion() : ''}
${o.operador && o.puedeComentar ? panelComentarios() : ''}`;
}
